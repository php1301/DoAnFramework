...
*/    [DbConfigurationType(typeof(MySql.Data.EntityFramework.MySqlEFConfigu‌​ration))]
   ...
   /*     public DbContext(IConfiguration config)
            : base(config["ConnectionStrings:MySqlConnectionString"])
        {
            Console.WriteLine(config["ConnectionStrings:MySqlConnectionString"]);
        }
*/
        ...
        public virtual IDbSet<SubmissionInput> Submissions { get; set; }
...
/*        public virtual IDbSet<SubmissionForProcessing> SubmissionsForProcessing { get; set; }*/
        ...
        public DbContext DbContextThis => this;
